...
export const columns: ColumnDef<TPerWP>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const curdata: number = row.getValue("bruto_cy");
      const formatted = convertNominal(curdata);
      return <div className="font-medium">{formatted}</div>;
    },
  },

  {
    ...
    cell: ({ row }) => {
      const curdata: number = row.getValue("naik_netto");
      const formatted = convertNominal(curdata);
      return <div className="font-medium">{formatted}</div>;
    },
  },
  {
    ...
    cell: ({ row }) => {
      const curdata: number = row.getValue("naik_bruto");
      const formatted = convertNominal(curdata);
      return <div className="font-medium">{formatted}</div>;
    },
  },
...

  {
    ...
    cell: ({ row }) => {
      const curdata: number = row.getValue("naik_bruto_pct");
      const formatted = (curdata * 100).toFixed(2);
      return <div className="font-medium">{formatted}%</div>;
    },
  },
...
//   },
//   cell: ({ row }) => {
//     const curdata: number = row.getValue("netto_py");
//     const formatted = convertNominal(curdata);
//     return <div className="font-medium">{formatted}</div>;
//   },
// },
...
//   },
//   cell: ({ row }) => {
//     const curdata: number = row.getValue("bruto_py");
//     const formatted = convertNominal(curdata);
//     return <div className="font-medium">{formatted}</div>;
//   },
// },
